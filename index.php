...
<html lang="fr">
  <head>
    ...
    <script
      src="https://kit.fontawesome.com/79fc45146d.js"
    ...
    <div id="bloc_principal">
      ...
      <nav>
        ...
        <a href="./pages/marathons.html">
          <img
            src="./assets/images/menu/dest.svg"
            alt="Les marathons dans le monde"
          />
          Marathons
        </a>
        <a href="./pages/alimentation.html">
          <img
            src="./assets/images/menu/conseils.svg"
            alt="Conseils pour la préparation d'un marathon"
          />
          conseils
        </a>
        <a href="#">
          <img
            src="./assets/images/menu/tems.svg"
            alt="Témoignages de marathoniens"
          />
          Témoignages
        </a>
        <a href="#">
          <img
            src="./assets/images/menu/nous.svg"
            alt="Equipe de Passion Marathons"
          />
          L'équipe
        </a>
      </nav>
      <div id="alaune">
        <img
          src="./assets/images/home/alaune/new-york.jpg"
          alt="Ligne d'arrivée du marathon de New York"
        />
        <div>
        ...
        <div>
          <a href="#">
            <figure>
              <div>
                <img
                  src="./assets/images/home/articles/medoc.jpg"
                  alt="Marathon du Médoc"
                />
              </div>
              <figcaption>
          ...
          <a href="#">
            <figure>
              <div>
                <img
                  src="./assets/images/home/articles/cognac.jpg"
                  alt="Marathon de Cognac"
                />
              </div>
              <figcaption>
          ...
          <a href="#">
            <figure>
              <div>
                <img
                  src="./assets/images/home/articles/dietetique.jpg"
                  alt="Préparation marathon"
                />
              </div>
              <figcaption>
      ...
      <section id="temoignage">
        ...
        <div>
          <blockquote>
            <em
              >Au départ : une adrénaline de ouf, au 32ème : un coup de barre
              XXL</em
            >
          </blockquote>
          ...
          <img
            src="./assets/images/home/temoignage/new-york-ligne.jpg"
            alt="temoignages_newyork"
          />
        </div>
      </section>
